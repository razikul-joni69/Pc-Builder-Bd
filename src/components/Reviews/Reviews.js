        ...
        <section className="flex items-center pb-10 font-poppins ">
            <div className="justify-center flex-1 max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
                    ...
                    <div className="p-6 mb-6 bg-gray-50 dark:bg-gray-900">
                        ...
                        <div className="flex justify-start ">
                            <div
                                ...
                                <div className="items-center font-bold ">{rating}/5</div>
                        ...
                        <div className="mb-6 text-xs dark:text-gray-400">{reviews?.length} customer reviews</div>
                ...
                </div>
                {
                    reviews?.map(review => {
                        return (
                            <div key={review?.username} className="p-4 bg-white shadow-2xl rounded-xl mb-5">
                                <div className="flex flex-wrap items-center space-x-2">
                                    ...
                                    <div className="flex items-center justify-center space-x-2 ">
                                        <div className="block">
                                            ...
                                            <div className="flex items-center justify-start w-full text-xs pt-2">
                                                <div
